...
public class ProMonstraoMvcApplication {
    ...
    public CommandLineRunner demo(ICityDAO cityDAO, ITheaterDAO theaterDAO, IWebsiteDAO websiteDAO,
        ...
        return (args) -> {
            ...
            Sale s1 = new Sale("O Quebra-Nozes", BigDecimal.valueOf(19.99),"2021-02-12T12:00", t1, w1);
            saleDAO.save(s1);

            Sale s2 = new Sale("Romeu e Julieta", BigDecimal.valueOf(19.99),"2021-03-13T13:00", t2, w1);
            saleDAO.save(s2);

            Sale s3 = new Sale("O Lago dos Cisnes", BigDecimal.valueOf(19.99),"2021-04-14T17:00", t3, w2);
            saleDAO.save(s3);

            Sale s4 = new Sale("Hamlet", BigDecimal.valueOf(19.99),"2021-05-15T18:00", t1, w3);
            saleDAO.save(s4);
